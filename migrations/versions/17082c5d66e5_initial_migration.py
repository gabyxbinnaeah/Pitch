...
Revision ID: 17082c5d66e5
Revises: 
Create Date: 2021-06-15 10:30:06.504896
...
def upgrade():
    ...
    op.create_index(op.f('ix_pitches_email'), 'pitches', ['email'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_pitches_email'), table_name='pitches')
